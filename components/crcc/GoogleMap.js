dojo.provide("imashup.components.crcc.GoogleMap");
...
dojo.declare(
    "imashup.components.crcc.GoogleMap",
    [dijit._Widget, dijit._Templated],
    {
		imashup_webos_large_icon_url: dojo.moduleUrl("imashup.components.crcc", "templates/gmap_large.png"),
		imashup_webos_small_icon_url: dojo.moduleUrl("imashup.components.crcc", "templates/gmap_small.png"),
		templatePath: dojo.moduleUrl("imashup.components.crcc", "templates/GMap.html"),
    ...
    height: 250,
		...
		postCreate: function(){
      this.mapContainer.style.width = imashup.mobileMode ? "" : "290px"
      this.mapContainer.style.height = imashup.mobileMode ? this.getDesktopBox().h - 40 +"px" : "190px"
...
imashup.core.componentTypeManager.registerComponentType({
    impl_name : 'imashup.components.crcc.GoogleMap',
    "interface": {
        properties: {},
        methods: {
